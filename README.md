# Topic Modeling Police Misconduct Data

This project was developed by [Pedro Galarza](https://github.com/pedroglrz) for the [Data Science & Software Services (DS3) Spring 2021 Portfolio](https://cds.nyu.edu/ds3/) at NYU (PI: George Wood).
